...
public class Prayer {
    ...
    private static String[] Prayer = new String[] {
    ...
    private static int prayIdx = random.nextInt(Prayer.length);
    
    public static void prayResp() {
    ...
    for(int i = 0; i < Prayer.length; i++) {
        ...
        String temp = Prayer[i];
        
        //[i] will become equal to whatever is in Index
        Prayer[i] = Prayer[prayIdx];
    ...
    System.out.println(Prayer[prayIdx]);
    }
